...
insert into pais values ("Finlândia", 338424, 5482013, "Euro", "Finlandês", , "Homem-Aranha", "Helsínquia", "República parlamentarista", @C_EU)
insert into pais values ("Índia", 3287260, 1311050527, "Rupia Indiana", "Hindi", , "Tempestade", "Nova Déli", "República Federal", @C_AS)
insert into pais values ("Paquistão", 796095, 188924874, "Rupia Paquistanesa", "Inglês", , "Wolverine", "Islamabade", "República parlamentarista", @C_AS)
insert into pais values ("Sri Lanca", 65610, 20966000, "Rupia Cingalesa", "Cingalês", , "Capitã Marvel", "Colombo, Sri Jaiavardenapura-Cota", "República semipresidencialista", @C_AS)
insert into pais values ("Filipinas", 300000, 100699395, "Peso Filipino", "Filipino", , "PRESIDENTE", "Manila", "República presidencialista", @C_AS)
insert into pais values ("Indonésia", 1910930, 257563815, "Rupia Indonésia", "Indonésio", , "PRESIDENTE", "Jacarta", "República presidencialista", @C_AS)
insert into pais values ("Vietnã", 331212, 91703800, "Dongue Vietnamita", "Vietnamita", , "PRESIDENTE", "Hanói", "Estado Unitário", @C_AS)
insert into pais values ("Coreia do Norte", 120538, 25155317, "Won norte-coreano", "Coreano", , "PRESIDENTE", "Pionguiangue", "República popular socialista", @C_AS)
insert into pais values ("Coreia do Sul", 99828, 50617045, "Won sul-coreano", "Coreano", , "PRESIDENTE", "Seul", "República presidencialista", @C_AS)
insert into pais values ("Líbano", 10452, 5850743, "Libra libanesa", "Árabe", , "PRESIDENTE", "Beirute", "República parlamentarista", @C_AS)
insert into pais values ("Angola", 1246700, 25021974, "Kwanza angolano", "Português", , "PRESIDENTE", "Luanda", "República presidencialista", @C_AFR)
insert into pais values ("Cabo Verde", 4033, 520502, "Escudo cabo-verdiano", "Português", , "PRESIDENTE", "Praia", "República unitária semipresidencialista", @C_AFR)
insert into pais values ("Guiné-Bissau", 36125, 1844325, "Franco", "Português", , "PRESIDENTE", "Bissau", "República semipresidencialista", @C_AFR)
insert into pais values ("Guiné Equatorial", 28051, 845060, "Franco", "Português", , "PRESIDENTE", "Malabo", "República semipresidencialista", @C_AFR)
insert into pais values ("Moçambique", 801590, 27977863, "Metical moçambicano", "Português", , "PRESIDENTE", "Maputo", "República semipresidencialista", @C_AFR)
insert into pais values ("São Tomé e Príncipe", 964, 190344, "Dobra de São Tomé e Príncipe", "Português", , "PRESIDENTE", "São Tomé", "República semipresidencialista", @C_AFR)
insert into pais values ("Camboja", 181035, 15577899, "Riel Cambojano", "Khmer", , "PRESIDENTE", "Pnom Pene", "Monarquia Constitucional", @C_AS)
insert into pais values ("Malásia", 330806, 30331007, "Ringuite Malario", "Malaio", , "PRESIDENTE", "Cuala Lumpur", "Monarquia Eletiva Constitucional", @C_AS)
insert into pais values ("Singapura", 710, 5535002, "Dolar de Singapura", "Inglês", , "PRESIDENTE", "Singapura", "Republica Parlamentarista", @C_AS)
insert into pais values ("Ruanda", 26338, 11609666, "Franco Ruandês", "Francês", , "PRESIDENTE", "Quigali", "Republica Semi Presidencialista", @C_AFR)
insert into pais values ("Suazilândia", 17364, 1286970, "Lilangeni suazilandês", "Inglês", , "PRESIDENTE", "Lobamba", "Monarquia Absoluta", @C_AFR)
insert into pais values ("Brasil", 8514880, 207847528, "Real ", "Português", , "PRESIDENTE", "Brasília", "República federativa presidencialista", @C_AMS)
