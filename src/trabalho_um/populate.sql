...
insert into cidade values ("1953-10-12", "Município de São Luís de Montes Belos", 825999, null, @P_BR);
insert into cidade values ("1951-11-22", "Município de São Luís do Curu", 12519, null, @P_BR);
insert into cidade values ("1995-12-14", "São Luis do Piauí", 2561, null, @P_BR);
